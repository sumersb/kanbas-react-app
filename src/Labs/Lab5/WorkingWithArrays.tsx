...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <input value={todo.id} className="form-control w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <input type="checkbox" id="wd-todo-completed" value={String(todo.completed)} className="form-check-input float-start me-2 mt-2"
                onChange={(e) => setTodo({ ...todo, completed: (!todo.completed) })} />
            <label className="form-check-label btn w-25 border" htmlFor="wd-todo-completed">
